...
size_t size_function__LedStatus__led_states(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<int64_t> *>(untyped_member);
  return member->size();
}

const void * get_const_function__LedStatus__led_states(const void * untyped_member, size_t index)
{
  const auto & member =
...
void * get_function__LedStatus__led_states(void * untyped_member, size_t index)
{
  auto & member =
...
void fetch_function__LedStatus__led_states(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const int64_t *>(
    get_const_function__LedStatus__led_states(untyped_member, index));
  auto & value = *reinterpret_cast<int64_t *>(untyped_value);
  value = item;
}

void assign_function__LedStatus__led_states(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<int64_t *>(
    get_function__LedStatus__led_states(untyped_member, index));
  const auto & value = *reinterpret_cast<const int64_t *>(untyped_value);
  item = value;
}

void resize_function__LedStatus__led_states(void * untyped_member, size_t size)
{
  auto * member =
    reinterpret_cast<std::vector<int64_t> *>(untyped_member);
  member->resize(size);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember LedStatus_message_member_array[1] = {
  {
    ...
    offsetof(my_robot_interfaces::msg::LedStatus, led_states),  // bytes offset in struct
    nullptr,  // default value
    size_function__LedStatus__led_states,  // size() function pointer
    get_const_function__LedStatus__led_states,  // get_const(index) function pointer
    get_function__LedStatus__led_states,  // get(index) function pointer
    fetch_function__LedStatus__led_states,  // fetch(index, &value) function pointer
    assign_function__LedStatus__led_states,  // assign(index, value) function pointer
    resize_function__LedStatus__led_states  // resize(index) function pointer
  }
};
