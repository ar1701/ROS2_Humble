...
size_t my_robot_interfaces__msg__LedStatus__rosidl_typesupport_introspection_c__size_function__LedStatus__led_states(
...
const void * my_robot_interfaces__msg__LedStatus__rosidl_typesupport_introspection_c__get_const_function__LedStatus__led_states(
...
void * my_robot_interfaces__msg__LedStatus__rosidl_typesupport_introspection_c__get_function__LedStatus__led_states(
...
void my_robot_interfaces__msg__LedStatus__rosidl_typesupport_introspection_c__fetch_function__LedStatus__led_states(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const int64_t * item =
    ((const int64_t *)
    my_robot_interfaces__msg__LedStatus__rosidl_typesupport_introspection_c__get_const_function__LedStatus__led_states(untyped_member, index));
  int64_t * value =
    (int64_t *)(untyped_value);
  *value = *item;
}

void my_robot_interfaces__msg__LedStatus__rosidl_typesupport_introspection_c__assign_function__LedStatus__led_states(
  void * untyped_member, size_t index, const void * untyped_value)
{
  int64_t * item =
    ((int64_t *)
    my_robot_interfaces__msg__LedStatus__rosidl_typesupport_introspection_c__get_function__LedStatus__led_states(untyped_member, index));
  const int64_t * value =
    (const int64_t *)(untyped_value);
  *item = *value;
}

bool my_robot_interfaces__msg__LedStatus__rosidl_typesupport_introspection_c__resize_function__LedStatus__led_states(
...
static rosidl_typesupport_introspection_c__MessageMember my_robot_interfaces__msg__LedStatus__rosidl_typesupport_introspection_c__LedStatus_message_member_array[1] = {
  {
    ...
    offsetof(my_robot_interfaces__msg__LedStatus, led_states),  // bytes offset in struct
    NULL,  // default value
    my_robot_interfaces__msg__LedStatus__rosidl_typesupport_introspection_c__size_function__LedStatus__led_states,  // size() function pointer
    my_robot_interfaces__msg__LedStatus__rosidl_typesupport_introspection_c__get_const_function__LedStatus__led_states,  // get_const(index) function pointer
    my_robot_interfaces__msg__LedStatus__rosidl_typesupport_introspection_c__get_function__LedStatus__led_states,  // get(index) function pointer
    my_robot_interfaces__msg__LedStatus__rosidl_typesupport_introspection_c__fetch_function__LedStatus__led_states,  // fetch(index, &value) function pointer
    my_robot_interfaces__msg__LedStatus__rosidl_typesupport_introspection_c__assign_function__LedStatus__led_states,  // assign(index, value) function pointer
    my_robot_interfaces__msg__LedStatus__rosidl_typesupport_introspection_c__resize_function__LedStatus__led_states  // resize(index) function pointer
  }
};
