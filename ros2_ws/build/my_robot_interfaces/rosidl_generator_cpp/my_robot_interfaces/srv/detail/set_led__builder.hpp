...
{
public:
  explicit Init_SetLed_Response_success(::my_robot_interfaces::srv::SetLed_Response & msg)
  : msg_(msg)
  {}
...
class Init_SetLed_Response_status_message
{
public:
  Init_SetLed_Response_status_message()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_SetLed_Response_success status_message(::my_robot_interfaces::srv::SetLed_Response::_status_message_type arg)
  {
...
{
  return my_robot_interfaces::srv::builder::Init_SetLed_Response_status_message();
}
